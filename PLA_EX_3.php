...
<head>
    ...
    <title>PLATAFORMA EXTENDIBLE 3 EJES</title>
<style>
       body {
...
<div class="container">
    <!-- Título -->
    <div class="title">PLATAFORMA EXTENDIBLE 3 EJES </div>
...
<div class="slider-container">
        ...
        <div class="slider-container">
            ...
            <input type="range" id="d1" name="d1" min="0" max="100" value="50" oninput="updateValue('d1Value', this.value)">
            <span class="value" id="d1Value">50%</span>
        </div>
        <div class="slider-container">
            <label for="d2">D2:</label>
            <input type="range" id="d2" name="d2" min="0" max="100" value="50" oninput="updateValue('d2Value', this.value)">
            <span class="value" id="d2Value">50%</span>
        </div>
        <div class="slider-container">
            <label for="d3">D3:</label>
            <input type="range" id="d3" name="d3" min="0" max="100" value="50" oninput="updateValue('d3Value', this.value)">
            <span class="value" id="d3Value">50%</span>
        </div>
        <div class="slider-container">
            <label for="d4">D4:</label>
            <input type="range" id="d4" name="d4" min="0" max="100" value="50" oninput="updateValue('d4Value', this.value)">
            <span class="value" id="d4Value">50%</span>
            </div>
    </form>
    ...
    <table class="checklist-table">
        ...
        <table>
             <td style="padding: 8px;">
                        ...
                        <select id="encargado1" name="encargado1" rows="5" required>
