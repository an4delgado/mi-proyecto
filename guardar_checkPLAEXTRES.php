...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO datos_extendible3(unidad, placas, fecha) VALUES (?, ?, ?)";
    ...
    $sql = "INSERT INTO plataforma_extendibletres (frenos, suspension, neumaticos, luces_intermitentes, luces_traseras,
    ...
    $sql = "INSERT INTO extendible_porcentaje (ejes,a1, a2, a3, a4, b1, b2, b3, b4, c1, c2, c3, c4,d1,d2,d3,d4)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    ...
    $sql = "INSERT INTO observaciones_exttres (observaciones) VALUES (?)";
    $stmt = $conn->prepare($sql);
    ...
    $sql = "INSERT INTO firmas_exttres (mantenimiento, operador, vigilancia) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
